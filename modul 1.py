...
dict = {
    ...
    "status"    : True,
    "sosmed"    : {
        "Github"    : "@Winnezcyntia30",
        "twiter"    : '_',
        "instagram" : '@Winnezcyntia_'
    }
}
...
for i in range(jumlah):
    ...
    data_mahasiswa["22001"] = {"nama": "Cyntia", "jurusan": "TI"}
print("\nCari data mahasiswa")
